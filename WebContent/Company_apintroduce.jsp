...
%>
<hr>
<jsp:include page="include/submenu/company.jsp" flush="true"/>
</div>
...
<table width="100%">
<tr align="right">
	<td><font color="gray" size="2">홈>회사소개>기종소개<hr></font></td>
</tr>
<tr align="left">
	<td><br><img src="<%=request.getContextPath() %>/include/fallback/company_apintroduce.png"></td>
</tr>
</table>
</div>
</div>
