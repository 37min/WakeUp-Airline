...
<% 
	List superlist = (List)request.getAttribute("superlist");
	...
	<table border="1" align="center" width="700px">
		...
		<%
			...
			for(int i = 0; i < superlist.size(); i++){
				SchBean sb = (SchBean)superlist.get(i);
		%>
		<tr>
			<td><%=sb.getSchNo()%></td>
			...
			<td><a href="./ReservProcessForm.jsp?SchNo=<%= sb.getSchNo() %>&memberID=<%= memberID %>">예약</a></td>  
		</tr>
	<% } %>
		
	</table>
	<hr>
	<input type="button" align=center value="돌아가기" onclick="location.href='ReservInsertForm.jsp';">
