...
<table width="100%">
<tr align="right">
	<td><font color="gray" size="2">홈>마이페이지>예약정보조회/변경<hr></font></td>
</tr>
<tr align="left">
	<td>
<%
...
%>
			...
			<table style="border: 1px solid #98bf21;border-collapse: collapse;text-align: center;">
				<tr style="font-size: 10pt;height: 30px;background-color:#EAF2D3;">
					...
					<td style="border: 1px solid #98bf21;"><b>취소여부</b></td>
				</tr>
<%
...
%>
					<tr>
						...
						<td style="border: 1px solid #98bf21;">
							<input type="radio" name="reservation_reservNo" value="<%=rrb.getrNo()%>">
							<input type="hidden" name="reservation_schNo" value="<%=rrb.getSchNo() %>">
						</td>
					</tr>
<%					
				}
%>				
					<tr style="font-size: 10pt;height: 30px;background-color:#EAF2D3;">
						<td colspan="8"  style="border: 1px solid #98bf21;"><input type="submit" value="선택항목 예약 취소하기"></td>
					</tr>
			</table>
			</form>
<%			
