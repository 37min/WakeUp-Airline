...
%>
<hr>
<jsp:include page="include/submenu/ascenter.jsp" flush="true"/>
</div>
...
<table width="100%">
<tr align="right">
	<td><font color="gray" size="2">홈>회원안내>회원등급안내<hr></font></td>
</tr>
<%-- 
<tr align="left">
	<td><br><img src="<%=request.getContextPath() %>/include/fallback/membership.png"></td>
</tr> 
--%>

<% request.setCharacterEncoding("euc-kr"); %>
<tr><td><jsp:include page="FaqPage.jsp" flush="false"/></td></tr>
